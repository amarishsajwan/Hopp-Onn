                    ...
                    <View className="mt-5 flex-col gap-y-4">
                        ...
                        <View className="flex-col gap-y-2.5">
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <ImageBackground
                                    source={licenseFrontImg ? { uri: licenseFrontImg } : icons.docsUpload}// Dynamically loaded background image URL
                                    resizeMode="cover"
                                ...
                                >
                                    <View className=" flex-col items-center justify-between bg-[#F9F9F9]/70 px-3 py-4 rounded-md">
                                        <View className=" flex-col items-center justify-center mb-3 ">
                                            ...
                                            <Text className="font-light text-[10px] text-[#1A1401]" >Only JPG, PNG with max sie 2MB</Text>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <ImageBackground
                                    source={licenseFrontImg ? { uri: licenseBackImg } : icons.docsUpload}// Dynamically loaded background image URL
                                    resizeMode="cover"
                                    className="flex-1" // Full-screen cover
                                >
                                    <View className=" flex-col items-center justify-between bg-[#F9F9F9]/70 px-3 py-4 rounded-md">
