  ...
  const fetchLocations = async () => {
    try {
      const response = await axios.get(
        `http://${process.env.EXPO_PUBLIC_IP_ADDRESS}:3000/api/v1/location/city/places`,
        ...
        <View className="mt-6 px-4 space-y-2">
          <View className="  items-start  mb-6 ">
            ...
            <View className="px-4 py-8 ">
              <Text className="px-1 font-semibold text-xl">
            ...
            <CustomButton
              ...
              handlePress={() => {
                console.log(
                  "validation before if condition",
                  pickupId,
                  dropId,
                  toTime,
                  fromTime,
